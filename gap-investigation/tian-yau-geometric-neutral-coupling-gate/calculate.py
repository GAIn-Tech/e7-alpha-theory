...
def main():
 ...
 ks={(pair,(0,),ex,(0,1,2),(0,)):c.F(1)}
 u.validate(ks,0); assert ks and c.total(ks)
 probes=bs+[ks]
 savedfs,savedarrows=c.fs,c.arrows
 records=[]; nilpotence=transport_nonzero=ideal_controls=transport_required=0
 try:
 ...
 assert ideal_controls>0 and transport_nonzero>0 and transport_required>0
 ...
 'family':records,'controls':{'omitted_basis_transport_detected':transport_required,'derivative_nilpotence_probes':nilpotence,'nonzero_exact_change_transports':transport_nonzero,'omitted_Koszul_derivative_detected':ideal_controls,'known_bundle_nonzero':nonzero,'positive_PQ_Taylor_generators':pq},
